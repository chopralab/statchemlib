/* This is logger.hpp and is part of StatChemLIB
...
#define log_note Logger::log<Severity::CD_NOTE>()
#define log_step Logger::log<Severity::CD_STEP>()
#define log_benchmark Logger::log<Severity::CD_BENCHMARK>()
#define log_warning Logger::log<Severity::CD_WARNING>()
#define log_error Logger::log<Severity::CD_ERROR>()
