...
set_property(TARGET OpenMM PROPERTY IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/usr/lib/${CMAKE_SHARED_LIBRARY_PREFIX}OpenMM${CMAKE_SHARED_LIBRARY_SUFFIX})
add_dependencies(OpenMM OpenMM_Build)

set(OPENMM_INCLUDE_DIR ${CMAKE_BINARY_DIR}/usr/include)
set(OPENMM_LIBRARY ${CMAKE_BINARY_DIR}/usr/lib/${CMAKE_SHARED_LIBRARY_PREFIX}OpenMM${CMAKE_SHARED_LIBRARY_SUFFIX})
set(OPENMM_PLUGIN_DIR ${CMAKE_BINARY_DIR}/usr/lib/plugins)
